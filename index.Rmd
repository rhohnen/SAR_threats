...
###Create subset with just overarching categories
heat_subset_data_over2 <- heat2 %>% select(12,17,18,19,21,22,23,24,26,27,28,30,31,32,33,35,36,37,38,40,41,42,44,45,46, 48,49,50,51,52,53,55,56,57,58,59,60,62,63,64,66,67,68,69,70)
# Assuming the dataset has 'Taxonomic_Group' and binary trait columns
