...
Compute correlations between variables that could be included in the models non appear to more than 0.4.
...
Run a glm that examine drivers of overlap in threats (Jaccard index) with caribou. These predictors include range size, percentage range overlap with caribou, taxonimic group and SARA status (threatened, endangered ect )
Quasibinomial chosen as the reponse variable (Jaccard index) goes from 0-1.
