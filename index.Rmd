...
Currently the best fitting model is be5, so these values are extracted.
```{r coef, echo=TRUE}
...
# Create grouped bar plot of percentages of species with range overlap/taxonomic group
