...
count_species_taxonomic_group <- ggplot(summary_data_overlap, aes(x = taxonomic_group, y = Count, fill = Category)) +
  ...
  labs(x = "Taxonomic group",
       y = "Number of species",
       fill = "Metric") +
  scale_fill_manual(values = c("cadetblue2", "cyan3", "dodgerblue", "darkblue", "purple","orchid"),
                    labels = c("SAR overlapping with caribou >80%","SAR overlapping with caribou >60%","SAR overlapping with caribou >40%","SAR overlapping with caribou >20%", "SAR overlapping with caribou", "SAR")) +
  theme_minimal() +
  theme(
    axis.title.y = element_text(margin = margin(t = 0, r = 30, b = 0, l = 0)),
...
# Create grouped bar plot of number of species
count_species_taxonomic_group_flip <- ggplot(summary_data_overlap, aes(x = taxonomic_group, y = Count, fill = Category)) +
  geom_bar(stat = "identity", position = "dodge") +
  coord_flip() +  # Correct function to flip axes
  labs(x = "Taxonomic group",
       y = "Number of species",
       fill = "Metric") +
  scale_fill_manual(values = c("cadetblue2", "cyan3", "dodgerblue", "darkblue", "purple","orchid"),
...
ggsave(
  filename = "./plots/count_species_taxonomic_group.jpg",
  plot = count_species_taxonomic_group_flip,
  device = "jpg",   height = 10, width = 17,
  units = "cm")
```
...
percentage_species_taxonomic_group_flipped <- ggplot(summary_data_overlap_percent, aes(x = taxonomic_group, y = Percentage, fill = Category)) +
  geom_bar(stat = "identity", position = "dodge", width = 0.6) +
  coord_flip() +  # Correct function to flip axes
  labs(
    x = "Taxonomic group",
  ...
  scale_fill_manual(
    values = c("purple4", "mediumpurple1"),
    labels = c("SAR overlapping with caribou >20%", "SAR overlapping with caribou")
  ) +
  theme_minimal() +
  ylim(0, 50) +
  theme(
...
# Save the plot
ggsave(
  filename = "./plots/percentage_species_taxonomic_group_flip.jpg",
  plot = percentage_species_taxonomic_group_flipped,
  device = "jpg",   height = 10, width = 17,
  units = "cm")
```
